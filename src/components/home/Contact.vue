      ...
      <div class="row">
        ...
        <div class="col col-12 col-md-6" >
          <div id="form_container">
            ...
            <small id="error_message" v-if="form.errorMessage">
              {{ form.errorMessage }}
            </small>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col col-12 col-md-5">
              ...
              <a href="https://www.facebook.com/henkorealestate" target="_blank"
                ><p class="green-text">Fb. Henko Consulta Inmobiliaria</p></a
              >
            </div>
        ...
        <div class="col col-12">
          ...
          <img
            class="contact-img mv"
            src="../../assets/img/s4-bg-m.png"
            alt=""
          />
        </div>
      </div>
