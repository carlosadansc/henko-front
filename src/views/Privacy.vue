<template>
  <div>
    <div class="container terms">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Henko Real Estate, Isabel La Católica 350,
            23000.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Henko Site, accessible from
            <a
              href="https://www.henkomexico.com"
              rel="external nofollow noopener"
              target="_blank"
              >https://www.henkomexico.com</a
            >
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: contacto@henkomexico.com</p>
        </li>
        <li>
          <p>By phone number: 6121694149</p>
        </li>
      </ul>
    </div>
    <Footer />
